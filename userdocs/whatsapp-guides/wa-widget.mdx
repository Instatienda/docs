...
<figure>
  <img
    src="https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/how-whatsapp-works/integrating-whatsapp-button/phone.png"
    alt="WhatsApp button in mobile devices"
  />
</figure>
...
<figure>
  <img
    src="https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/how-whatsapp-works/integrating-whatsapp-button/desktop.png"
    alt="WhatsApp button on a desktop"
  />
</figure>

### 2. Configure the phone number that the WhatsApp button will redirect to in a new window when clicked. Replace `<Add your phone number here>` with the desired phone number.
