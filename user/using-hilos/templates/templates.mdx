...
They can also be used with [Broadcasts](/user/create-a-broadcast) and [Flows](/user/creating-a-flow).
...
<figure>
  <img src='https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/using-hilos/reference/templates/templates/img1.png' />
  <figcaption>Template example</figcaption>
</figure>

<Tip>
Templates can be used to send massive messaging campaings using [Broadcasts](/user/create-a-broadcast), however try to follow [best practices](/user/broadcast-best-practices) so you're not marked as spam or blocked by users.
</Tip>
