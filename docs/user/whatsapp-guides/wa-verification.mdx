...
- Your business on the business manager must already be [verified by Facebook.](/docs/user/advanced/business-verification)
...
![WhatsApp Manager Account tools](https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/how-whatsapp-works/green-checkmark/manager-sidebar.png)

3. Choose your phone number and click on the gear icon, then click on Profile

![WhatsApp Manager Gear icon](https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/how-whatsapp-works/green-checkmark/gear-icon.jpeg)

4. Submit a request for an Official Business Account (Green tick for WhatsApp Business API)

![WhatsApp Manager WA Official Request](https://hilos-media.s3.us-east-2.amazonaws.com/documentation/userdocs/how-whatsapp-works/green-checkmark/verification.jpeg)
