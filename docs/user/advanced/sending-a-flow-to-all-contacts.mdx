...
1. Your contact list size and your phone number limits: keep in mind that usually phone numbers are capped to 1,000 conversations each month, if you send a message to all your contacts there is a chance that you overshoot that limit and your messages will start to fail with the error `Spam rate: limit hit`
...
3. Before sending this message your template must be approved, otherwise it will fail.
