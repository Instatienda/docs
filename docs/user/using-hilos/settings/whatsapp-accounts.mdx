...
Now, simply follow the connection guide, which you can find [here](/docs/user/getting-started/connect-a-new-number). If you already have a phone number connected to Hilos, you can skip step 1 of the guide and use the existing app instead.
