...
Our native Inbox ChatGPT integration can help your team to communicate more effectively with your customers. It will provide suggestions for answers to an specific question, based on the context of the conversation. This will help your team to provide faster and more accurate responses to your customers. To set it up go to Integrations > External apps and click on Settings on the ChatGPT card.

<Note>
  You might need to [contact support](https://api.whatsapp.com/send?phone=525592257050) to enable a feature flag on your account to be able to visualize the integration on your account.
</Note>
